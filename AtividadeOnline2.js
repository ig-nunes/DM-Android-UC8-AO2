...
(obs.: Essa parte foi adicionada como extra ao sistema de cadastros para verificar se o evento escolhido possui data válida ou se 
    o mesmo já passou);
(Obs1.: A data atual e as datas dos eventos foram criadas a partir da função random: por exemplo, caso o valor 
...
de forma aninhada ou não, e recriar de uma melhor forma o fluxograma da atividade online 1, além de ter adicionado a verificação 
de datas;
                    ...
                    if (data < data1){
                        if (quant1 < 100 && listpart1.length < 100){
                            ...
                            while (exit == false){
                                ...
                                let idade1 = idade.question("insira sua idade:");
